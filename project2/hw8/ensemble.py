...
def main():
    ...
    model_path1 = "bert_output/checkpoint-14000/"
    model_path2 = "roberta_output/DuReader/checkpoint-32000/"
    model_path3 = "roberta_large_output/DuReader/checkpoint-60000/"
    ...
    model1 = AutoModelForQuestionAnswering.from_pretrained(
        model_path1,
        from_tf=bool("ckpt" in model_path1),
        config=config1,
        cache_dir=args.cache_dir if args.cache_dir else None,
    )
    ...
    model2 = AutoModelForQuestionAnswering.from_pretrained(
        model_path2,
        from_tf=bool("ckpt" in model_path2),
        config=config2,
        cache_dir=args.cache_dir if args.cache_dir else None,
    )
    ...
    model3 = AutoModelForQuestionAnswering.from_pretrained(
        model_path3,
        from_tf=bool("ckpt" in model_path3),
        config=config3,
        cache_dir=args.cache_dir if args.cache_dir else None,
    )
    ...
    model3.to(args.device)
    # Evaluate
    result = evaluate(args, model_path1, model1, model2, model3, tokenizer1, prefix="")
